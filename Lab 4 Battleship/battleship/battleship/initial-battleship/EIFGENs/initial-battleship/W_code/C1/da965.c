...
{
	GTCX
	RTOTC (F965_7246,13526,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F965_7251,13531,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F965_7252,13532,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F965_7253,13533,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit965 (void)
{
	GTCX
	RTOTS (7246,F965_7246)
