...
static const EIF_TYPE_INDEX egt_1_1079 [] = {0xFF01,247,1078,0xFFFF};
...
static const struct desc_info desc_1079[] = {
	...
	{EIF_GENERIC(egt_9_1079), 15522, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1079), 15520, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1079), 15521, 0xFFFFFFFF},
};
void Init1079(void)
{
	IDSC(desc_1079, 0, 1078);
	IDSC(desc_1079 + 1, 1, 1078);
	IDSC(desc_1079 + 32, 413, 1078);
}
