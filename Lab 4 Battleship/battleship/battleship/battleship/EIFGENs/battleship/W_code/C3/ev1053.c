...
extern EIF_TYPED_VALUE F1053_9073(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1053_9073 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1052, Current, 0, 1, 15339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1052, Current, 15339);
	RTIV(Current, RTAL);
	RTHOOK(1);
