...
extern EIF_TYPED_VALUE F1292_11734(EIF_REFERENCE);
extern void F1292_11735(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1292_11734 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1292_11735 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1291, Current, 0, 0, 18511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1291, Current, 18511);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8340, 0xF80005A0, 0); /* implementation */
