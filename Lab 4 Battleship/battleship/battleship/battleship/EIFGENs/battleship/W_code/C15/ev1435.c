...
extern void F1435_13817(EIF_REFERENCE);
static EIF_TYPED_VALUE F1435_13821_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1435_13821(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1435_13817 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1434, Current, 0, 0, 20238);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1434, Current, 20238);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1435_13821_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1435_13821 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1435_13821_body (Current)).it_r;
