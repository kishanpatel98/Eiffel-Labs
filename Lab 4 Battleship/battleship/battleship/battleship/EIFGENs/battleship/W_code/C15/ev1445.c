...
extern EIF_TYPED_VALUE F1445_13906(EIF_REFERENCE);
extern void F1445_13911(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1445_13912(EIF_REFERENCE);
static EIF_TYPED_VALUE F1445_13913_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1445_13913(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1445_13906 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1444, Current, 1, 0, 20276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1444, Current, 20276);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8634, "is_selected", tr2))(tr2)).it_b);
		if (tb2) {
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9270, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(6,1);
...
void F1445_13911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1444, Current, 0, 0, 20277);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1444, Current, 20277);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 10549, 0x04000000, 1); /* default_key_processing_disabled */
	*(EIF_BOOLEAN *)(Current + RTWA(10549, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1445_13912 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1445_13913_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1444, Current, 0, 0, 20279);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1444, Current, 20279);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1445_13913 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1445_13913_body (Current)).it_r;
