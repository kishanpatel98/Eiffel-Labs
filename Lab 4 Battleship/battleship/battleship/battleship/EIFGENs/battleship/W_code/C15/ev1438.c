...
extern void F1438_13886(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1438_13887_body(EIF_REFERENCE);
...
void F1438_13886 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1437, Current, 1, 1, 20267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1437, Current, 20267);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10791, "update_for_pick_and_drop", tr2))(tr2, ub1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1438_13887_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1437, Current, 0, 0, 20268);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1437, Current, 20268);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1438_13887 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1438_13887_body (Current)).it_r;
