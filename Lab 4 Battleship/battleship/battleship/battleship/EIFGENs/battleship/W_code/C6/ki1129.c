...
extern EIF_TYPED_VALUE F1129_9973(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1129_9973 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1128, Current, 0, 1, 16373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1128, Current, 16373);
	RTCC(arg1, 1128, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
