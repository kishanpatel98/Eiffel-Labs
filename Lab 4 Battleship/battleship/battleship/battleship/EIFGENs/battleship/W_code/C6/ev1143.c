...
extern void F1143_10072(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1143_10073(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1143_10074(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1143(void);
extern EIF_REFERENCE _A1143_183_2_3_4_5();
...
void F1143_10072 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1142, Current, 0, 1, 16732);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1142, Current, 16732);
	{
	...
	*((EIF_INTEGER_32 *)tr3+3) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1143_183_2_3_4_5, (EIF_POINTER)(0),7711, tr2, 0, 1, -1, tr1, 4);
	}
	ur1 = RTCCL(tr4);
...
void F1143_10073 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1142, Current, 0, 5, 16733);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1142, Current, 16733);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,259,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		RTCC(arg5, 1142, l_feature_name, 5, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
...
EIF_TYPED_VALUE F1143_10074 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1142, Current, 0, 1, 16734);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1142, Current, 16734);
	RTIV(Current, RTAL);
