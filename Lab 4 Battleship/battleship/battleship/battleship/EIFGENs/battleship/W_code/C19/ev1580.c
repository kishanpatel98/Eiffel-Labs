...
extern EIF_TYPED_VALUE F1580_11962(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1580_11963(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1580_11964(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1580_11965(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1580_11966(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1580_11967(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1580_11968(EIF_REFERENCE);
extern void F1580_16358(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1580_11962 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1579, Current, 0, 1, 18744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1579, Current, 18744);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(3,1);
	ur1 = RTCCL(arg1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9898, "item_by_data", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
EIF_TYPED_VALUE F1580_11963 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1579, Current, 0, 0, 18745);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1579, Current, 18745);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8345, 1578))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1580_11964 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1579, Current, 3, 0, 18746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1579, Current, 18746);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			{
				EIF_TYPE_INDEX typarr0[] = {1579,0,0,0xFFFF};
				EIF_TYPE typres0;
				{
					EIF_TYPE l_type;
...
EIF_TYPED_VALUE F1580_11965 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1579, Current, 2, 0, 18747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1579, Current, 18747);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1580_11966 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1579, Current, 2, 2, 18740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1579, Current, 18740);
	{
...
EIF_TYPED_VALUE F1580_11967 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1580_11968 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1580_16358 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1579, Current, 0, 16357);
	RTSA(dtype);
	RTME(dtype, 0);
