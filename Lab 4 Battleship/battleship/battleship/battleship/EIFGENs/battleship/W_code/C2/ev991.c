...
extern EIF_TYPED_VALUE F991_8460(EIF_REFERENCE);
static EIF_TYPED_VALUE F991_8461_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_8461(EIF_REFERENCE);
...
EIF_TYPED_VALUE F991_8460 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 990, Current, 1, 0, 14790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 14790);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6293, 0xF800047C, 0); /* selection_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F991_8461_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 14791);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(990, Current, 14791);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F991_8461 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6293,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6293, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F991_8461_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6293,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
