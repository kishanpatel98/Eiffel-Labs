...
extern EIF_TYPED_VALUE F993_8469(EIF_REFERENCE);
extern EIF_TYPED_VALUE F993_8470(EIF_REFERENCE);
...
RTOID (F993_8469)
EIF_TYPED_VALUE F993_8469 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 14796);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 14796);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F993_8470)
EIF_TYPED_VALUE F993_8470 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 14797);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 14797);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8469,F993_8469)
	RTOTS (8470,F993_8470)
}
