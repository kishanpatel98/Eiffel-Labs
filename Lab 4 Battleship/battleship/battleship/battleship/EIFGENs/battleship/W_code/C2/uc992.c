...
extern EIF_TYPED_VALUE F992_8468(EIF_REFERENCE);
...
RTOID (F992_8468)
EIF_TYPED_VALUE F992_8468 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 991, Current, 0, 0, 14795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 14795);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
