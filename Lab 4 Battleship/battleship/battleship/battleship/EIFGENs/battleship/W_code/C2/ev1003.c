...
extern EIF_TYPED_VALUE F1003_8564(EIF_REFERENCE);
static EIF_TYPED_VALUE F1003_8565_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_8565(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1003_8564 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 14891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14891);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6398, 0xF800047C, 0); /* change_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1003_8565_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14892);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 14892);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1003_8565 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6398, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_8565_body (Current)).it_r;
