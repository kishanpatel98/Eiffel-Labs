...
static const EIF_TYPE_INDEX egt_1_1020 [] = {0xFF01,247,1019,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,1129,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_GENERIC(egt_13_1020), 14961, 0xFFFFFFFF},
};
void Init1020(void)
{
	IDSC(desc_1020, 0, 1019);
	IDSC(desc_1020 + 1, 1, 1019);
	IDSC(desc_1020 + 32, 552, 1019);
}
