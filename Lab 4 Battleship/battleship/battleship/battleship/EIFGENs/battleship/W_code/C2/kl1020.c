...
extern EIF_TYPED_VALUE F1020_8658(EIF_REFERENCE);
...
RTOID (F1020_8658)
EIF_TYPED_VALUE F1020_8658 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1019, Current, 0, 0, 14961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1019, Current, 14961);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
