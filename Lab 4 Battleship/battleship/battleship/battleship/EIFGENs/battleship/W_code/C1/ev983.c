...
extern EIF_TYPED_VALUE F983_8422(EIF_REFERENCE);
static EIF_TYPED_VALUE F983_8423_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8423(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8424(EIF_REFERENCE);
static EIF_TYPED_VALUE F983_8425_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8425(EIF_REFERENCE);
...
EIF_TYPED_VALUE F983_8422 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 14752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 14752);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6255, 0xF800047C, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F983_8423_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 14753);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(982, Current, 14753);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_8423 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6255, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F983_8423_body (Current)).it_r;
...
EIF_TYPED_VALUE F983_8424 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 14754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 14754);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6257, 0xF800047C, 0); /* deselect_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F983_8425_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 14755);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(982, Current, 14755);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_8425 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6257, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F983_8425_body (Current)).it_r;
