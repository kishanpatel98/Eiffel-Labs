...
static const struct desc_info desc_960[] = {
	...
	{EIF_NON_GENERIC(0x0195 /*202*/), 13407, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_960), 13408, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01CF /*231*/), 13409, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_960), 13410, 0xFFFFFFFF},
};
void Init960(void)
{
	IDSC(desc_960, 0, 959);
	IDSC(desc_960 + 1, 1, 959);
	IDSC(desc_960 + 32, 850, 959);
}
