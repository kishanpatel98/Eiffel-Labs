...
extern EIF_TYPED_VALUE F989_8454(EIF_REFERENCE);
static EIF_TYPED_VALUE F989_8455_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F989_8455(EIF_REFERENCE);
extern EIF_TYPED_VALUE F989_8456(EIF_REFERENCE);
static EIF_TYPED_VALUE F989_8457_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F989_8457(EIF_REFERENCE);
...
EIF_TYPED_VALUE F989_8454 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 14784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 14784);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6287, 0xF800047C, 0); /* drop_down_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6287, dtype)) = (EIF_REFERENCE) tr1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
static EIF_TYPED_VALUE F989_8455_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 988, Current, 0, 0, 14785);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(988, Current, 14785);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F989_8455 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6287, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F989_8455_body (Current)).it_r;
...
EIF_TYPED_VALUE F989_8456 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 988, Current, 1, 0, 14786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 14786);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6289, 0xF800047C, 0); /* list_hidden_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F989_8457_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 988, Current, 0, 0, 14787);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(988, Current, 14787);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F989_8457 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6289, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F989_8457_body (Current)).it_r;
