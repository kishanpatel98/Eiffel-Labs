...
extern EIF_TYPED_VALUE F1468_14462(EIF_REFERENCE);
static EIF_TYPED_VALUE F1468_14465_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1468_14465(EIF_REFERENCE);
...
/* {EV_ITEM_I}.parent */
EIF_TYPED_VALUE F1468_14462 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 1, 0, 20758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 20758);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1579,0xFF01,1300,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1468_14465_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1467, Current, 0, 0, 20759);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1467, Current, 20759);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1468_14465 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1468_14465_body (Current)).it_r;
