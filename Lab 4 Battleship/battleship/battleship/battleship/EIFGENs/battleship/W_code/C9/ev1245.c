...
extern EIF_TYPED_VALUE F1245_11097(EIF_REFERENCE);
extern void F1245_11098(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1245_11099(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1245_11100(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1245_11097 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1244, Current, 0, 0, 17872);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1244, Current, 17872);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9417, "help_context", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1244, Current, 1, 1, 17869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1244, Current, 17869);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,438,0xFF01,0xFFF9,0,185,0xFF01,1028,0xFFFF};
		EIF_TYPE typres0;
...
body:;
	...
	RTNHOOK(3,1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9418, "set_help_context", tr1))(tr1, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1244, Current, 0, 0, 17870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1244, Current, 17870);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8340, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(9419, "remove_help_context", tr1))(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1245_11100 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
