...
extern void F1530_15488(EIF_REFERENCE);
extern void F1530_15489(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1530_15490(EIF_REFERENCE);
...
void F1530_15488 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1529, Current, 5, 0, 21631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1529, Current, 21631);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11357, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1530_15489 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1529, Current, 0, 0, 21632);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1529, Current, 21632);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1530_15490 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1530_15490,21634,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1530 (void)
{
	GTCX
	RTOTS (15490,F1530_15490)
}
