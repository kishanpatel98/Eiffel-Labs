...
extern EIF_TYPED_VALUE F1111_9699(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1111_9699 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 15938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1110, Current, 15938);
	RTIV(Current, RTAL);
