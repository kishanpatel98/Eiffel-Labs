...
extern void F1092_9346(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1092_9347(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1092_9348(EIF_REFERENCE);
...
/* {ETF_CHAR_ARG}.make */
void F1092_9346 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1091, Current, 0, 1, 15591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1091, Current, 15591);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7099, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7114, 0x08000000, 1); /* value */
	*(EIF_CHARACTER_8 *)(Current + RTWA(7114, dtype)) = (EIF_CHARACTER_8) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
/* {ETF_CHAR_ARG}.value */
EIF_TYPED_VALUE F1092_9347 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
	r.it_c1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7114,Dtype(Current)));
	return r;
}


/* {ETF_CHAR_ARG}.out */
EIF_TYPED_VALUE F1092_9348 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1091, Current, 0, 0, 15593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1091, Current, 15593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
	tr1 = RTMS_EX_H("\'",1,39);
	tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7114, dtype));
	tr2 = c_outc(tc1);
	ur1 = RTCCL(tr2);
