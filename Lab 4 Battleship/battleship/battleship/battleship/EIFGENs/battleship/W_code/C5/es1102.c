...
extern void F1102_9393(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1102_9394(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1102_9395(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1102_9396(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1102_9397(EIF_REFERENCE);
...
void F1102_9393 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1101, Current, 0, 2, 15634);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1101, Current, 15634);
	RTCC(arg1, 1101, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,260,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7147, 0xF8000104, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7143, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7145, 0xF80000E7, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7145, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7149, 0xF80000E7, 0); /* expected_tag_name */
...
void F1102_9394 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1101, Current, 0, 3, 15635);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1101, Current, 15635);
	RTCC(arg1, 1101, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,260,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
	...
	RTCC(arg3, 1101, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1102_9395 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1101, Current, 3, 0, 15636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1101, Current, 15636);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 7141, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(7141, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7149, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
	...
	if (tb1) {
		RTHOOK(6);
		RTDBGAA(Current, dtype, 7141, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(7141, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 7142, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(7145, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(10);
		RTDBGAA(Current, dtype, 7146, 0x10000000, 1); /* violation_type */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1264, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(7146, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F1102_9396 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1101, Current, 0, 0, 15637);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1101, Current, 15637);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1102_9397 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
