...
extern void F1096_9358(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1096_9359(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1096_9360(EIF_REFERENCE);
...
/* {ETF_TUPLE_ARG}.make */
void F1096_9358 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1095, Current, 0, 1, 15603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15603);
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(7099, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7122, 0xF8000106, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
/* {ETF_TUPLE_ARG}.value */
EIF_TYPED_VALUE F1096_9359 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {ETF_TUPLE_ARG}.out */
EIF_TYPED_VALUE F1096_9360 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1095, Current, 1, 0, 15605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15605);
	RTIV(Current, RTAL);
	RTHOOK(1);
