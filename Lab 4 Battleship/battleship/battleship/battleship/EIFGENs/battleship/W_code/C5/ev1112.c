...
extern EIF_TYPED_VALUE F1112_9700(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1112_9700 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1111, Current, 0, 0, 15939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1111, Current, 15939);
	RTIV(Current, RTAL);
