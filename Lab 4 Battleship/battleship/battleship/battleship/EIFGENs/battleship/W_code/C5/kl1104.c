...
extern EIF_TYPED_VALUE F1104_9403(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1104_9403 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1103, Current, 2, 2, 15644);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1103, Current, 15644);
	if (arg1) {
		RTCC(arg1, 1103, l_feature_name, 1, eif_new_type(231, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 1103, l_feature_name, 2, eif_new_type(231, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (RTCEQ(arg1, arg2)) {
