...
static EIF_TYPED_VALUE F1491_14723_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1491_14723_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1491_14723 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1491_14723_body (Current)).it_r;
