...
extern EIF_TYPED_VALUE F1514_15191(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1514_15191 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1513, Current, 0, 0, 21395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1513, Current, 21395);
	RTIV(Current, RTAL);
	RTHOOK(1);
