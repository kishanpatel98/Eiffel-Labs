...
extern void F1409_13451(EIF_REFERENCE);
extern void F1409_13452(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13453(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1409_13454(EIF_REFERENCE);
static EIF_TYPED_VALUE F1409_13455_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1409_13455(EIF_REFERENCE);
...
void F1409_13451 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9266, 1404))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9266, 1586))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1409_13452 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 1, 2, 19940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1408, Current, 19940);
	RTCC(arg1, 1408, l_feature_name, 1, RTWCT(10231, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1409_13453 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 2, 1, 19941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1408, Current, 19941);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(9863, dtype)) = (EIF_INTEGER_32) loc2;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1409_13454 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19937);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1408, Current, 19937);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10254, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1409_13455_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19938);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1408, Current, 19938);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1409_13455 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9271, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1409_13455_body (Current)).it_r;
