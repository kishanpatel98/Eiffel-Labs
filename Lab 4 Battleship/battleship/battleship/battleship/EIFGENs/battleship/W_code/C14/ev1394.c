...
extern EIF_TYPED_VALUE F1394_13172(EIF_REFERENCE);
extern void F1394_16374(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1394_13172 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1394_16374 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1393, Current, 0, 16373);
	RTSA(dtype);
	RTME(dtype, 0);
