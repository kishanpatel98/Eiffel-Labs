...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_13_980), 13725, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_980), 13726, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_980), 13732, 0xFFFFFFFF},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
	IDSC(desc_980 + 1, 1, 979);
	IDSC(desc_980 + 32, 417, 979);
	IDSC(desc_980 + 36, 414, 979);
}
