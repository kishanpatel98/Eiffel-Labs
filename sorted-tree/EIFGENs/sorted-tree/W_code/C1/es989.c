...
extern void F989_7544(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F989_7545(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F989_7544 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 988, Current, 0, 2, 13791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 13791);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5294, 0xF8000100, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F989_7545 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 988, Current, 0, 3, 13792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
