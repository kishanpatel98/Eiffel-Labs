...
extern EIF_TYPED_VALUE F960_7194(EIF_REFERENCE);
...
extern void F960_7202(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F960_7203(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7204(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7205(EIF_REFERENCE);
extern void F960_7206(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F960_7207(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F960_7208(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7209(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F960_7210(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F960_7211(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F960_7202
static void inline_F960_7202 (EIF_POINTER arg1)
{
	#ifdef EIF_WINDOWS
...
#define INLINE_F960_7202
#endif
#ifndef INLINE_F960_7206
static void inline_F960_7206 (EIF_POINTER arg1, EIF_POINTER arg2)
{
	*(time_t *) arg2 = (((struct timeval *)arg1)->tv_sec);
	;
}
#define INLINE_F960_7206
#endif
#ifndef INLINE_F960_7209
static EIF_POINTER inline_F960_7209 (EIF_POINTER arg1)
{
	return (EIF_POINTER) (localtime ((time_t *) arg1))
	;
}
#define INLINE_F960_7209
#endif
#ifndef INLINE_F960_7210
static EIF_POINTER inline_F960_7210 (EIF_POINTER arg1)
{
	return (EIF_POINTER) (gmtime ((time_t *) arg1))
	;
}
#define INLINE_F960_7210
#endif
...
void F960_7190 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4981, 0x04000000, 1); /* is_utc */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 959, Current, 4, 0, 13479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(3);
	up1 = loc1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4991, dtype))(Current, up1x);
	RTHOOK(4);
	up1 = loc1;
	up2 = loc3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(4995, dtype))(Current, up1x, up2x);
	RTHOOK(5);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(4981, dtype));
	if (tb1) {
		RTHOOK(6);
		...
		up1 = loc3;
		loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4999, dtype))(Current, up1x)).it_p);
	} else {
		RTHOOK(7);
		RTDBGAL(Current, 2, 0x40000000, 1, 0); /* loc2 */
		up1 = loc3;
		loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4998, dtype))(Current, up1x)).it_p);
	}
	RTHOOK(8);
	RTDBGAA(Current, dtype, 4997, 0xF80000AB, 0); /* internal_item */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4997, dtype)) = (EIF_REFERENCE) tr1;
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc4 < ((EIF_INTEGER_32) 0L)) || (EIF_BOOLEAN) (loc4 > ((EIF_INTEGER_32) 999999L)))) {
		RTHOOK(11);
		RTDBGAA(Current, dtype, 4990, 0x10000000, 1); /* microseconds_now */
		*(EIF_INTEGER_32 *)(Current + RTWA(4990, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	} else {
		RTHOOK(12);
		RTDBGAA(Current, dtype, 4990, 0x10000000, 1); /* microseconds_now */
...
/* {C_DATE}.year_now */
EIF_TYPED_VALUE F960_7194 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tp1 = *(EIF_POINTER *)(tr1 + RTVA(3281, "item", tr1));
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5004, dtype))(Current, up1x)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tp1 = *(EIF_POINTER *)(tr1 + RTVA(3281, "item", tr1));
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5005, dtype))(Current, up1x)).it_i4);
	RTHOOK(2);
...
EIF_TYPED_VALUE F960_7200 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13486);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = *(EIF_INTEGER_32 *)(Current + RTWA(4990, Dtype(Current)));
...
/* {C_DATE}.gettimeofday */
void F960_7202 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13488);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(959, Current, 13488);
	RTIV(Current, RTAL);
	inline_F960_7202 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
EIF_TYPED_VALUE F960_7203 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F960_7204 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13490);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
EIF_TYPED_VALUE F960_7205 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13491);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
/* {C_DATE}.get_time */
void F960_7206 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 2, 13492);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(959, Current, 13492);
	RTIV(Current, RTAL);
	inline_F960_7206 ((EIF_POINTER) arg1, (EIF_POINTER) arg2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
/* {C_DATE}.localtime */
EIF_TYPED_VALUE F960_7209 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTIV(Current, RTAL);
	Result = inline_F960_7209 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
/* {C_DATE}.gmtime */
EIF_TYPED_VALUE F960_7210 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTIV(Current, RTAL);
	Result = inline_F960_7210 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
/* {C_DATE}.get_tm_year */
EIF_TYPED_VALUE F960_7211 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13498);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13499);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13500);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13501);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 1, 13502);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
