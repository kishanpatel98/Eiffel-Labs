...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1003, Current, 0, 1, 13926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	tr8 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5377, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ui4_1 = arg1;
	tr9 = ((up3x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5511, "item", tr8))(tr8, ui4_1x)), (((up3x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up3x.it_r = RTBU(up3x))), (up3x.type = SK_POINTER), up3x.it_r);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1003, Current, 0, 2, 13927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
