...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1020, Current, 5, 2, 13512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1020, Current, 9, 2, 13513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2252, "item", arg1))(arg1, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2209, "has", Result))(Result, ur1x)).it_b);
			tb2 = tb4;
			RTHOOK(30);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1020, Current, 6, 1, 13514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
