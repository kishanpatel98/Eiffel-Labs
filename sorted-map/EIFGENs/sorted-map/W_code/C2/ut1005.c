...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1004, Current, 5, 2, 13503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)tr1 = ti4_1;
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
		...
		for (;;) {
			if (!tb3) break;
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "after", loc4))(loc4)).it_b);
			if (tb4) break;
			RTHOOK(15);
		...
		RTHOOK(17);
		RTCT("across 1 |..| (b.count) as j all Result.has (b[j.item]) end", EX_POST);
		RTHOOK(18);
		RTDBGAL(Current, 4, 0xF80001E5, 0, 0); /* loc5 */
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1004, Current, 9, 2, 13504);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5006, dtype))(Current, ur1x, ur2x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(11);
	...
	if (RTAL & CK_ENSURE) {
		...
		RTHOOK(24);
		RTDBGAL(Current, 4, 0xF80001E5, 0, 0); /* loc7 */
		ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2665, "lower", Result));
		...
		*(EIF_INTEGER_32 *)tr1 = ti4_1;
		...
		RTHOOK(28);
		RTDBGAL(Current, 5, 0xF80001E5, 0, 0); /* loc8 */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2269, "count", arg1))(arg1)).it_i4);
		ui4_1 = ti4_1;
		tr1 = RTLN(eif_new_type(218, 0x00).id);
		*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
		...
		for (;;) {
			if (!tb2) break;
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "after", loc8))(loc8)).it_b);
			if (tb3) break;
			RTHOOK(29);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3144, "item", loc8))(loc8)).it_i4);
			ui4_1 = ti4_1;
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2252, "item", arg1))(arg1, ui4_1x)).it_i4);
			ui4_1 = ti4_1;
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2209, "has", Result))(Result, ui4_1x)).it_b);
			tb2 = tb4;
			RTHOOK(30);
		...
		RTHOOK(31);
		RTCT("across 1 |..| (right.count) as r_c all Result.has (right[r_c.item]) end", EX_POST);
		RTHOOK(32);
		RTDBGAL(Current, 6, 0xF80001E5, 0, 0); /* loc9 */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2269, "count", arg2))(arg2)).it_i4);
		ui4_1 = ti4_1;
		tr1 = RTLN(eif_new_type(218, 0x00).id);
		*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
		...
		for (;;) {
			if (!tb2) break;
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "after", loc9))(loc9)).it_b);
			if (tb3) break;
			RTHOOK(33);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3144, "item", loc9))(loc9)).it_i4);
			ui4_1 = ti4_1;
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2252, "item", arg2))(arg2, ui4_1x)).it_i4);
			ui4_1 = ti4_1;
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2209, "has", Result))(Result, ui4_1x)).it_b);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1004, Current, 6, 1, 13505);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
