note
	description: "Summary description for {LINEAR_TESTS}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature  -- int key tests
	...
	map: SORTED_LINEAR_MAP[INTEGER, PERSON]
		attribute
...
feature -- p key tests
	...
	p_map: SORTED_LINEAR_MAP[PERSON, STRING]
		attribute
			create Result.make_empty
		end
...
feature -- precondition tests
	...
	pr_map: SORTED_LINEAR_MAP[INTEGER, INTEGER]
		attribute
			create Result.make_empty
		end
