/*
 * Code for class SORTED_BST [INTEGER_32, INTEGER_32]
 */
...
extern void F1045_7812(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1045_7812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1044, Current, 2, 2, 14229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg2) {
		{
			...
			typres0 = eif_compound_id(dftype, typarr0);
			RTCC(arg2, 1044, l_feature_name, 2, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1044, Current, 5, 1, 14230);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1044, Current, 0, 1, 14231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
