/*
 * Code for class SORTED_ADT [INTEGER_32, INTEGER_32]
 */
...
extern EIF_TYPED_VALUE F1044_7755(EIF_REFERENCE);
extern void F1044_7756(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1044_7763(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1044_7768(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1044_7773(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1044_7774(EIF_REFERENCE);
extern void F1044_8372(EIF_REFERENCE, int);
...
/* {SORTED_ADT}.model */
EIF_TYPED_VALUE F1044_7755 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 14105);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1043, Current, 14105);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1044_7756 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 14106);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1043, Current, 14106);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1043, Current, 1, 1, 14107);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14107);
	RTIV(Current, RTAL);
...
body:;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5386, "value", loc1))(loc1)).it_i4);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5386, "value", tr4))(tr4)).it_i4);
		if ((Result == ti4_1)) {
			RTCK;
		} else {
			RTCF;
...
/* {SORTED_ADT}.count */
EIF_TYPED_VALUE F1044_7768 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 14108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14108);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1043, Current, 1, 1, 14109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14109);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1043, Current, 2, 1, 14110);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14110);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("key_exists", EX_PRE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1043, Current, 1, 1, 14111);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1043, Current, 14111);
	{
...
/* {SORTED_ADT}.out */
EIF_TYPED_VALUE F1044_7773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1043, Current, 1, 0, 14112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14112);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1044_7774 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 14113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14113);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1044_8372 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLU(SK_REF, &loc3);
	RTLU(SK_REF, &loc4);
	RTEAINV(l_feature_name, 1043, Current, 4, 8371);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("sorted", Current);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5433, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
