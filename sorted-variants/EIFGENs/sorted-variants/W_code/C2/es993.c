...
extern void F993_7558(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F993_7559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F993_7560(EIF_REFERENCE);
extern EIF_TYPED_VALUE F993_7561(EIF_REFERENCE);
...
void F993_7558 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 992, Current, 0, 2, 13836);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13836);
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5293, 0xF8000354, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F993_7559 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 992, Current, 3, 0, 13837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13837);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F993_7560 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 13838);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(992, Current, 13838);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F993_7561 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
