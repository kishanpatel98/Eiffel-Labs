...
{
	GTCX
	RTOTC (F962_7237,13552,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F962_7242,13557,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F962_7243,13558,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F962_7244,13559,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit962 (void)
{
	GTCX
	RTOTS (7237,F962_7237)
	RTOTS (7238,F962_7238)
	RTOTS (7239,F962_7239)
	RTOTS (7240,F962_7240)
	RTOTS (7241,F962_7241)
	RTOTS (7242,F962_7242)
	RTOTS (7243,F962_7243)
