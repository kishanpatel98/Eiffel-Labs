...
extern EIF_TYPED_VALUE F982_7443(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {TIME_UTILITY}.mod */
EIF_TYPED_VALUE F982_7443 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 2, 13741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 2, 13742);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13743);
	RTSA(Dtype(Current));
	RTSC;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13744);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5024, "default_format_string", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
