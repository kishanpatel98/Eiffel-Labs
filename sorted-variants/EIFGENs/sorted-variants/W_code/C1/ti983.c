...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13750);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5026, "time_default_format_string", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
