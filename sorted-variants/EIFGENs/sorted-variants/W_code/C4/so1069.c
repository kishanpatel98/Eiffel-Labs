/*
 * Code for class SORTED_BST [G#1, G#2]
 */
...
extern void F1069_7812(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1069_7813(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1069_7814(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1069_7812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1068, Current, 2, 2, 14235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 14235);
	{
	...
	if (arg2) {
		{
			...
			typres0 = eif_compound_id(dftype, typarr0);
			RTCC(arg2, 1068, l_feature_name, 2, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1069_7813 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1068, Current, 5, 1, 14236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 14236);
	{
...
void F1069_7814 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1068, Current, 0, 1, 14237);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 14237);
	{
