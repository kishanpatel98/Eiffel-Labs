...
static const EIF_TYPE_INDEX egt_13_1025 [] = {0xFF01,903,0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1025 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1025 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1025 [] = {0xFF01,1007,0xFFFF};
...
static const struct desc_info desc_1025[] = {
	...
	{EIF_GENERIC(egt_13_1025), 13910, 0},
	{EIF_GENERIC(NULL), 13911, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13912, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1025), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1025), 13941, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1025), 13942, 0xFFFFFFFF},
...
void Init1025(void)
{
	...
	IDSC(desc_1025 + 32, 410, 1024);
	IDSC(desc_1025 + 36, 390, 1024);
	IDSC(desc_1025 + 39, 401, 1024);
}
