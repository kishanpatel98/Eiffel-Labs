...
extern EIF_TYPED_VALUE F1051_8016(EIF_REFERENCE);
...
RTOID (F1051_8016)
EIF_TYPED_VALUE F1051_8016 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1050, Current, 0, 0, 14217);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14217);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
