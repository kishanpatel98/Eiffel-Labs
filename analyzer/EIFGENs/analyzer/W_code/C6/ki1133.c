...
extern EIF_TYPED_VALUE F1133_7657(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1133_7658(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_7660(EIF_REFERENCE);
extern void F1133_7665(EIF_REFERENCE);
extern void F1133_7666(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1133_7657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1132, Current, 2, 3, 13894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 13894);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1131,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5150, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F1133_7658 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1132, Current, 0, 0, 13895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 13895);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1133_7660 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1132, Current, 0, 0, 13896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 13896);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F1133_7665 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1132, Current, 0, 0, 13897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 13897);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1133_7666 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1132, Current, 0, 0, 13898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 13898);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
