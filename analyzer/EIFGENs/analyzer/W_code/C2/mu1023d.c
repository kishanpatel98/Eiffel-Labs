...
static const EIF_TYPE_INDEX egt_13_1023 [] = {0xFF01,903,0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1023 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1023 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1023 [] = {0xFF01,1007,0xFFFF};
...
static const struct desc_info desc_1023[] = {
	...
	{EIF_GENERIC(egt_13_1023), 13910, 0},
	{EIF_GENERIC(NULL), 13911, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13912, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1023), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1023), 13941, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1023), 13942, 0xFFFFFFFF},
...
void Init1023(void)
{
	...
	IDSC(desc_1023 + 32, 410, 1022);
	IDSC(desc_1023 + 36, 390, 1022);
	IDSC(desc_1023 + 39, 401, 1022);
}
