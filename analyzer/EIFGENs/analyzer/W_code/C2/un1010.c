/*
 * Code for class UNARY_EXPRESSION
 */
...
extern void F1010_9380(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1009, Current, 0, 0, 13936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1009, Current, 13936);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1009, Current, 0, 1, 13937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1009, Current, 13937);
	RTCC(arg1, 1009, l_feature_name, 1, eif_new_type(1007, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {UNARY_EXPRESSION}._invariant */
void F1010_9380 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1009, Current, 0, 9379);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("unary_operands", Current);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5437, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
