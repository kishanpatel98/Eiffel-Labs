...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,903,0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1024 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1024 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1024 [] = {0xFF01,1007,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_13_1024), 13910, 0},
	{EIF_GENERIC(NULL), 13911, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13912, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1024), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1024), 13941, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1024), 13942, 0xFFFFFFFF},
...
void Init1024(void)
{
	...
	IDSC(desc_1024 + 32, 410, 1023);
	IDSC(desc_1024 + 36, 390, 1023);
	IDSC(desc_1024 + 39, 401, 1023);
}
