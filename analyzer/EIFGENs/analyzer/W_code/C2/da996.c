...
extern EIF_TYPED_VALUE F996_7624(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_7625(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_7626(EIF_REFERENCE);
...
EIF_TYPED_VALUE F996_7624 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F996_7625 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F996_7626 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13886);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13886);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5354, "fractional_second", tr1));
