...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,903,0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1020 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1020 [] = {0xFF01,1007,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1020 [] = {0xFF01,1007,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_GENERIC(egt_13_1020), 13910, 0},
	{EIF_GENERIC(NULL), 13911, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13912, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1020), 0x00, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1020), 13941, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1020), 13942, 0xFFFFFFFF},
...
void Init1020(void)
{
	...
	IDSC(desc_1020 + 32, 410, 1019);
	IDSC(desc_1020 + 36, 390, 1019);
	IDSC(desc_1020 + 39, 401, 1019);
}
