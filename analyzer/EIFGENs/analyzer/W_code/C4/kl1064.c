...
extern EIF_TYPED_VALUE F1064_8102(EIF_REFERENCE);
...
RTOID (F1064_8102)
EIF_TYPED_VALUE F1064_8102 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1063, Current, 0, 0, 14298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1063, Current, 14298);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
