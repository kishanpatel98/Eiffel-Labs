...
extern EIF_TYPED_VALUE F1086_8414(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1086_8414 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1085, Current, 0, 0, 14630);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1085, Current, 14630);
	RTIV(Current, RTAL);
	RTHOOK(1);
