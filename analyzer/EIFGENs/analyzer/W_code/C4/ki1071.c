...
extern EIF_TYPED_VALUE F1071_8268(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1071_8270(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1071_8268 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1070, Current, 2, 3, 14488);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1070, Current, 14488);
	RTCC(arg1, 1070, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1071_8270 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1070, Current, 0, 1, 14489);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1070, Current, 14489);
	RTIV(Current, RTAL);
	RTHOOK(1);
