...
extern void F1103_8714(EIF_REFERENCE);
extern void F1103_8715(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1103_8716(EIF_REFERENCE);
...
void F1103_8714 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1102, Current, 4, 0, 14869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1102, Current, 14869);
	RTIV(Current, RTAL);
...
void F1103_8715 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1102, Current, 0, 0, 14870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1102, Current, 14870);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1103_8716 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1103_8716,14872,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1103 (void)
{
	GTCX
	RTOTS (8716,F1103_8716)
}
