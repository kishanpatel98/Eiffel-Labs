...
extern void F983_7460(EIF_REFERENCE);
extern void F983_7461(EIF_REFERENCE);
extern void F983_7462(EIF_REFERENCE);
...
extern void F983_7468(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F983_7469(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7470(EIF_REFERENCE);
extern void F983_7473(EIF_REFERENCE);
...
void F983_7460 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 13741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5252, dtype))(Current);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
...
void F983_7461 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5256, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5256, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F983_7462 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5257, 0x04000000, 1); /* browser */
	*(EIF_BOOLEAN *)(Current + RTWA(5257, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13744);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5253, 0xF80000E8, 0); /* default_html_name */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5253, Dtype(Current))) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13745);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5256, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5256, Dtype(Current))) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13747);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5247, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F983_7468 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13748);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F983_7469 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13749);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(5257, dtype));
	if (tb1) {
		RTHOOK(3);
		...
		if (tb1) {
			...
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5249, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 13750);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13750);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F983_7473 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 982, Current, 6, 0, 13735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F983_7478 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5257,Dtype(Current)));
	return r;
}
